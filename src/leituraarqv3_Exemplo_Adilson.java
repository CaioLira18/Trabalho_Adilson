...
public class leituraarqv3_Exemplo_Adilson {
    public static void main(String[] args) {
        // Especifique o caminho para o arquivo de texto
        String caminhoArquivo = "C:\\\\Users\\\\PC\\\\OneDrive\\\\Documentos\\\\Área de Trabalho\\\\Pastas\\\\Trabalho_Adilson\\\\exercicio_1\\\\src\\\\arquivos\\\\Produto.txt";
        int codigo = 0;
        String nome;
        String valors;
        double valor = 0;
